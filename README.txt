...
task3
	...
	DAR totusi am avut o problema pentru ca nu stiam ca rangeul trebuie luat cu cu pasul 1.01/bin_counts pana la 1.01. Si timp de multe ore am cautat sa gasesc "problema" in alta parte decat in acest interval, pentru ca mai apoi sa descopar pe forum ca problema este una comuna.Ar fi fost mai bine sa primim un hint in legatura cu acest lucru, pentru ca nu era unul foarte evident.
